...
// String method for individual Repository
func (r *Repository) String() string {
	...
	sb.WriteString(fmt.Sprintf("  Stars: %d, Forks: %d, Watchers: %d\n",
		r.StargazersCount, r.Forks, r.Watchers))
	sb.WriteString(fmt.Sprintf("  Created: %s\n", r.CreatedAt.Format("2006-01-02")))
	sb.WriteString(fmt.Sprintf("  Updated: %s\n", r.UpdatedAt.Format("2006-01-02")))
	sb.WriteString(fmt.Sprintf("  URL: %s\n", r.HTMLURL))
	sb.WriteString(fmt.Sprintf("  Private: %t, Archived: %t, Fork: %t",
		r.Private, r.Archived, r.Fork))
...
// String method for Repositories slice
